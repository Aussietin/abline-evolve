...
- [x] Genuine gameplay screenshot captured from the live v1 HTML5 build at `release/screenshots/itch/gameplay.png` (Gen 2, Row 1/4, 662 m record; full field and tractor fleet visible)
